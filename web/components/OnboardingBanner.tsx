...
import { AlertCircle, X, Terminal, Key, Smartphone, Zap } from 'lucide-react';
...
export function OnboardingBanner() {
  ...
  // Don't show if backend not reachable, or dismissed
    ...
    <div className="border-b border-helix-red/30 bg-helix-red/5 px-4 py-3 lg:pl-4 pl-16">
      <div className="flex items-start gap-2 max-w-4xl mx-auto">
        ...
        <div className="flex-1 text-xs space-y-2">
          <div className="font-medium text-helix-red-light">
...
{`# Option A: Your gateway (NOTE: most gateways need /v1 suffix!)
